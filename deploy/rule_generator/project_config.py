...
class ProjectConfig(object):
  ...
  def __init__(self, project, audit_logs_project, generated_fields):
    ...
    self._partial_overall = {
        field_generating.GENERATED_FIELDS_NAME: generated_fields
    }

    self.project_id = self._project_config['project_id']
    self.enabled_apis = self._project_config.get('enabled_apis')

    self._forseti_gcp_reader = field_generating.get_forseti_service_generated_fields(
  ...
  def get_project_bindings(self):
    ...
    project_num = field_generating.get_generated_fields_copy(
  ...
  def get_audit_logs_bigquery_bindings(self):
    ...
    writers = [
        _service_account_name(
            field_generating.get_generated_fields_copy(
                self._project_config['project_id'],
  ...
  def get_gce_instances(self):
    ...
    generated_fields_copy = field_generating.get_generated_fields_copy(
